...
const ActionsAndNumbers = ({ numbersConclusions, actionConclusions }) => {
    return (
        <PoseGroup animateOnMount={true}>
            {actionConclusions.length > 0 && <ActionsNowDue key="actions" actionConclusions={actionConclusions} />}
            {numbersConclusions.length > 0 && <MyNumbers key="numbers" numbersConclusions={numbersConclusions} />}
        </PoseGroup>
    )
}
