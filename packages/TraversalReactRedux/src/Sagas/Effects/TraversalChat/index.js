...
export default traversalApi => ([
    ...
    takeLatest(actions.TRAVERSAL_PREVIOUS, generators.createPreviousChatGenerator(traversalApi)),
    takeLatest(actions.TRAVERSAL_AUTO, generators.createAutoForwardChatGenerator()),
